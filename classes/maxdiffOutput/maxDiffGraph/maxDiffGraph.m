...
@interface maxDiffGraph () <LocationProtocol,sliderProtocolDelegate,UIPopoverPresentationControllerDelegate>
{
    ...
    [[APIManager new] postJSONRequest:@"mckinsey/PHP/_IPHONE/MCKINSEY/get_predefined_controls_user.php" andParam:@{@"DATA":surveyId} withBlock:^(id response, BOOL isSuccess) {
        ...
        if (isSuccess) {
            ...
            for (NSMutableDictionary *attributeDict in selectedDemoGraphicsList) {
                ...
                surveyName = [[attributeDict objectForKey:@"SURVEY_NAME"] stringValue];
...
//            _surveyNameLabel.text = [response[0] valueForKey:@"SURVEY_NAME"];
//            [NSString stringWithFormat:@"Survey Name : %@",surveyName];
    ...
    _surveyNameLabel.text = surveyName;
    ...
    dispatch_async(dispatch_get_main_queue(), ^
                   {
                       ...
                       else
                       {
                           ...
                           fpUsingMdOutputObj.finalSelectedValues = finalSelectedValues;
