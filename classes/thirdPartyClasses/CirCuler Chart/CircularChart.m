...
//    [textLayer setFrame:CGPathGetBoundingBox(shapeLayer.path)];
//    [textLayer setString:[NSString stringWithFormat:@"%d",(int)value]];
...
//    [self.circularChartView.layer addSublayer:textLayer];
}
