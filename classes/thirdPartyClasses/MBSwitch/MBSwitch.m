...
- (void) configure {
    ...
    _onTintColor = [UIColor colorWithRed:51.0/255.0 green:204.0/255.0 blue:153.0/255.0 alpha:1.0];
    [self setBacklayerOnTintColorIfNeeded];
    
    _tintColor = [UIColor colorWithRed:247.0/255.0 green:75.0/255.0 blue:75.0/255.0 alpha:1.0];
    ...
    _fillLayer.fillColor =  [[UIColor colorWithRed:247.0/255.0 green:75.0/255.0 blue:75.0/255.0 alpha:1.0] CGColor];;
    ...
    _thumbLayer.shadowOpacity = 0.0;
    //_thumbLayer.fillColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"switchThumb.png"]].CGColor;
